...
-   [R Basics](Introduction to R/r-basics.qmd) — fundamental functions, built-in datasets, and data exploration.
-   [R Packages](Introduction to R/packages.qmd) — installing and using essential data science packages.
